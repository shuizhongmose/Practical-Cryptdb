...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/string dup_item =" << current_thd << std::endl;
...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/int dup_item =" << current_thd << std::endl;
...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/null dup_item =" << current_thd << std::endl;
...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/func dup_item =" << current_thd << std::endl;
...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/float dup_item =" << current_thd << std::endl;
...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/field dup_item =" << current_thd << std::endl;
                ...
                const std::string &field_name)
{
    ...
    // std::cout << "-------- current_thd in parser/lex_util.cc/make_item_field =" << current_thd << std::endl;
    assert(current_thd);
              ...
              const std::string &field_name)
{
    ...
    // std::cout << "-------- current_thd in parser/lex_util.cc/make_item_ref =" << current_thd << std::endl;
    assert(current_thd);
...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/make_item_insert_value =" << current_thd << std::endl;
...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/make_item_string =" << current_thd << std::endl;
    return new (current_thd->mem_root) Item_string(make_thd_string(s),
                                                   s.length(),
...
{
    // std::cout << "-------- current_thd in parser/lex_util.cc/make_order =" << current_thd << std::endl;
